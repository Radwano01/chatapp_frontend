        ...
        <div className="flex items-center mb-4 justify-between">
          <div className="flex items-center">
            <img
              ...
              className="w-8 h-8 sm:w-12 sm:h-12 rounded-full object-cover mr-2 sm:mr-3 cursor-pointer hover:opacity-80 transition"
              onClick={() => {
              ...
              <li key={member.id} className="flex items-center justify-between">
                <div className="flex items-center">
                  <img
                    ...
                    alt={member.fullName}
                    className="w-6 h-6 sm:w-8 sm:h-8 rounded-full object-cover mr-2 cursor-pointer hover:opacity-80 transition"
                    onClick={() => {
